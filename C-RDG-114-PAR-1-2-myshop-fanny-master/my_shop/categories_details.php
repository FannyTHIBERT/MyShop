...
<body>
    ...
    <div class="col adminbtn">
            ...
            <h1>Détails de la catégorie <?= $result1['name'] ?></h1>
       
            <hr>    
            <p>ID : <?= $result1['id'] ?></p>
                <p>Name : <?= $result1['name'] ?></p>
                <p>Parent_id : <?= $result1['parent_id'] ?></p>
                <p><a class="btn btn-dark " href="categories_admin.php">Retour</a> <a class="btn btn-warning" href="categories_edit.php?id=<?= $result1['id'] ?>">Modifier</a> <a class="btn btn-danger" href="categories_delete.php?id=<?= $result1['id'] ?>">Supprimer</a></p>
        </div>
